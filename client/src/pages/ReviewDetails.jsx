  ...
  return (
    <div>
      ...
      <div className="bg-white p-6 rounded-xl shadow">
        ...
        <p>
          <strong>PR:</strong> #{review.prNumber}
        </p>

        <p>
          <strong>Title:</strong> {review.prTitle}
        </p>

        <p>
          <strong>Author:</strong> {review.prAuthor}
        </p>

        <p>
          <strong>Total Issues:</strong> {review.totalIssues}
        </p>
      ...
      <div className="mt-6 space-y-4">
        {review?.issues?.map((issue, index) => (
          <div key={index} className="bg-white p-4 rounded-xl shadow">
            ...
            <p>Recommendation: {issue.suggestion}</p>
